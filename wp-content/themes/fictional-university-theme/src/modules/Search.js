...
class Search {
    ...
    getResults() {
            ...
            this.resultsDiv.html(`
                <div class="row">
                    ...
                    <div class="one-third">
                        ...
                        <h2 class="search-overlay__section-title">Professors</h2>                         ${results.professors.length ? '<ul class="professor-cards">' : `<p>No professors match that search.</p>`}
        ...
        //delete this code later (old routes)
        // $.when(
